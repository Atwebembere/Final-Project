...
table1(~ Sex + Age + Class + Allowance + Friendwhosmokes + Parentwhosmoke + Seenantismokingad + Seenprosmokingcontent | Riskoftobaccouse1, data = imp1)

table1(~ Sex + Age + Class + Allowance + Friendwhosmokes + Parentwhosmoke + Seenantismokingad + Seenprosmokingcontent | Riskoftobaccouse2, data = imp1)
...
plotC <- ggplot(data = imp1) + 
  geom_bar(position = "dodge", aes(x = Riskoftobaccouse1, fill = Seenantismokingad)) +  # fill and dodge work together here
  scale_fill_manual(values = c("Yes" = "blue", "No" = "red")) +  # custom colors for Seenantismokingad
  labs(title = "Risk of tobacco use 1 by Seen anti-smoking advertisement", x = "If one of your best friends offered you a tobacco product, would you use it?", y = "Count") +  # proper axis labels
  theme_minimal()  # minimal theme for clean look
plotC

# plot D - histogram
plotD <- ggplot(data = imp1) + 
  geom_bar(position = "dodge", aes(x = Riskoftobaccouse2, fill = Seenantismokingad)) +  # fill and dodge work together here
  scale_fill_manual(values = c("Yes" = "blue", "No" = "green")) +  # custom colors for Seenantismokingad
  labs(title = "Risk of tobacco use 2 by Seen anti-smoking advertisement", x = "At anytime during the next 12 months do you think you will use any form of tobacco?", y = "Count") +  # proper axis labels
  theme_minimal()  # minimal theme for clean look
plotD

# plot E - histogram
plotE <- ggplot(data = imp1) + 
  geom_bar(position = "dodge", aes(x = Riskoftobaccouse1, fill = Seenprosmokingcontent)) +  # fill and dodge work together here
  scale_fill_manual(values = c("Yes" = "black", "No" = "pink")) +  # custom colors for Seenprosmokingcontent
  labs(title = "Risk of tobacco use 1 by Seen pro-smoking content", x = "If one of your best friends offered you a tobacco product, would you use it?", y = "Count") +  # proper axis labels
  theme_minimal()  # minimal theme for clean look
plotE

# plot F - histogram
plotF <- ggplot(data = imp1) + 
  geom_bar(position = "dodge", aes(x = Riskoftobaccouse2, fill = Seenprosmokingcontent)) +  # fill and dodge work together here
  scale_fill_manual(values = c("Yes" = "grey", "No" = "pink")) +  # custom colors for Seenprosmokingcontent
  labs(title = "Risk of tobacco use 2 by Seen pro-smoking content", x = "At anytime during the next 12 months do you think you will use any form of tobacco?", y = "Count") +  # proper axis labels
  theme_minimal()  # minimal theme for clean look
plotF
...
combined_plot1 <- ggarrange(plotD, plotE, plotF, nrow = 2, ncol = 2, 
          common.legend = FALSE, 
          labels = c("D", "E", "F"), legend = "bottom")
